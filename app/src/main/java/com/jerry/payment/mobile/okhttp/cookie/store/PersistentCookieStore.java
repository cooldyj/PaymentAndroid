package com.jerry.payment.mobile.okhttp.cookie.store;
...
public class PersistentCookieStore implements CookieStore
{
    ...
    protected String encodeCookie(SerializableHttpCookie cookie)
    {
        ...
        {
            Logs.d(LOG_TAG, "IOException in encodeCookie");
            return null;
        }
    ...
    protected Cookie decodeCookie(String cookieString)
    {
        ...
        {
            Logs.d(LOG_TAG, "IOException in decodeCookie");
        } catch (ClassNotFoundException e)
        {
            Logs.d(LOG_TAG, "ClassNotFoundException in decodeCookie");
        }
