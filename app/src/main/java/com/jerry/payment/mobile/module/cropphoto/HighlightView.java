...
class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth = resources.getDrawable(R.drawable.me_camera_crop_width);
        mResizeDrawableHeight = resources.getDrawable(R.drawable.me_camera_crop_height);
        mResizeDrawableDiagonal = resources.getDrawable(R.drawable.me_indicator_autocrop);
    }
