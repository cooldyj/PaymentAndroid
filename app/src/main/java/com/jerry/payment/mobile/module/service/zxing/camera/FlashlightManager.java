...
final class FlashlightManager {
  ...
  static {
    ...
    if (iHardwareService == null) {
      Logs.v(TAG, "This device does supports control of a flashlight");
    } else {
      Logs.v(TAG, "This device does not support control of a flashlight");
    }
  }
  ...
  private static Class<?> maybeForName(String name) {
    try {
      ...
      Logs.w(TAG, "Unexpected error while finding class " + name);
      return null;
    }
  }
  ...
  private static Method maybeGetMethod(Class<?> clazz, String name, Class<?>... argClasses) {
    try {
      ...
      Logs.w(TAG, "Unexpected error while finding method " + name);
      return null;
    }
  }
  ...
  private static Object invoke(Method method, Object instance, Object... args) {
    try {
      ...
      Logs.w(TAG, "Unexpected error while invoking " + method);
      return null;
