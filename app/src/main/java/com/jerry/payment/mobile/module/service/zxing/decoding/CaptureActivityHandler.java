package com.jerry.payment.mobile.module.service.zxing.decoding;
...
import com.jerry.payment.mobile.module.service.zxing.view.ViewfinderResultPointCallback;
  ...
  public void handleMessage(Message message) {
    switch (message.what) {
      case R.id.auto_focus:
        //Logs.d(TAG, "Got auto-focus message");
      ...
      case R.id.restart_preview:
        Logs.d(TAG, "Got restart preview message");
        restartPreviewAndDecode();
        break;
      case R.id.decode_succeeded:
        Logs.d(TAG, "Got decode succeeded message");
        state = State.SUCCESS;
      ...
      case R.id.return_scan_result:
        Logs.d(TAG, "Got return scan result message");
        activity.setResult(Activity.RESULT_OK, (Intent) message.obj);
        activity.finish();
        break;
      case R.id.launch_product_query:
        Logs.d(TAG, "Got product query message");
