...
public class BankCardListAdapter extends BaseAdapter {
    ...
    public BankCardListAdapter(Context context, List<BankCardInfo> bankCardInfos) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.me_bank_card_list_item, null);
            ...
            holder.deleteIV = (ImageView) convertView.findViewById(R.id.bank_card_delete);
            holder.modifyIV = (ImageView) convertView.findViewById(R.id.bank_card_modify);
        ...
        if(info != null){
            ...
            holder.modifyIV.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
